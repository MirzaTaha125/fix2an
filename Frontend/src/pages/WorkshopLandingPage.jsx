		...
		<div className="min-h-screen bg-white pb-16 md:pb-0 relative">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="text-center lg:text-left">
						    ...
						    <div className="flex justify-center lg:justify-start gap-4">
							    <Link to="/workshop/signup" className="max-md:w-full max-md:block">
								    <Button 
									    size="lg" 
									    className="w-auto text-sm sm:text-base md:text-lg px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 h-auto font-semibold rounded-xl md:rounded-lg shadow-none md:shadow-lg hover:shadow-xl transition-all duration-300 max-md:w-full max-md:flex max-md:items-center max-md:justify-center max-md:gap-2 max-md:py-4 bg-[#34C759] text-white"
								    >
			...
			<section className="py-24 bg-white">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<Card className="flex flex-col items-center text-center p-8 rounded-[2.5rem] border-none bg-gray-50 hover:shadow-xl transition-all duration-300 group">
							<div className="w-20 h-20 rounded-full flex items-center justify-center mb-6 shadow-sm bg-[#34C759]/10 group-hover:scale-110 transition-transform">
								<Building2 className="w-10 h-10 text-[#34C759]" />
							</div>
						...
						<Card className="flex flex-col items-center text-center p-8 rounded-[2.5rem] border-none bg-gray-50 hover:shadow-xl transition-all duration-300 group">
							<div className="w-20 h-20 rounded-full flex items-center justify-center mb-6 shadow-sm bg-[#34C759]/10 group-hover:scale-110 transition-transform">
								<DollarSign className="w-10 h-10 text-[#34C759]" />
							</div>
							<h3 className="text-2xl font-bold mb-4 text-[#05324f]">
				...
				<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex flex-col md:flex-row items-center justify-center gap-16">
						<div className="flex-shrink-0 relative">
                            <div className="absolute inset-0 bg-[#34C759]/10 blur-2xl rounded-full scale-125"></div>
							<div 
								className="w-48 h-48 sm:w-64 sm:h-64 drop-shadow-xl mx-auto relative z-10"
								style={{ 
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
                    <h2 className="text-4xl font-bold text-[#05324f] mb-6">Ready to grow your workshop?</h2>
                    <p className="text-xl text-gray-600 mb-10 leading-relaxed">Join hundreds of other workshops already using Fix2An to grow their business. It takes less than 5 minutes to get started.</p>
                    <Link to="/workshop/signup" className="max-md:w-full max-md:block">
                        <Button 
                            size="lg" 
                            className="w-auto text-sm sm:text-base md:text-lg px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-5 h-auto font-semibold rounded-xl md:rounded-2xl shadow-none md:shadow-lg hover:shadow-xl transition-all duration-300 max-md:w-full max-md:flex max-md:items-center max-md:justify-center max-md:gap-2 max-md:py-5 bg-[#34C759] text-white"
                        >
                            Get Started Now
                        </Button>
                    </Link>
